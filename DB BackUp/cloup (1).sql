...
-- Χρόνος δημιουργίας: 04 Ιουν 2020 στις 18:38:57
...
INSERT INTO `ergazomenos` (`kwd_ergazomenou`, `Eponymo_ergazom`, `Onoma_Ergazom`, `Patronymo_Ergazom`, `Fyllo_Ergaz`, `AFM_Ergaz`, `DOB_Ergazom`, `Tel_Ergaz`, `Salary_Ergazom`, `Kod_tm_ergazom`, `user_type_ergazom`, `alias`, `crypto`) VALUES
...
(13, 'THODOS', 'ANTONIS', 'THODOS', 'M', 111111130, '0000-00-00', 691111129, 2150, 13, 1, 'antonis', 'thodos');
